...
// images.
void
parsePGM(const char* filename, std::shared_ptr<uint8_t>& data, uint32_t& rows,
	uint32_t& cols)
{
	// Open PGM file.
...
int main(int argc, char** argv)
{
	...
	try {
		modelInfoObj = NFIQ2::ModelInfo("nist_plain_tir-ink.txt");
	}
	catch (...) {
		std::cerr
	...
	parsePGM("C:/Freelancer/Khurran Hanif/NFIQ2_Wrapper/test_images/SFinGe_Test01.pgm", data, rows, cols);
